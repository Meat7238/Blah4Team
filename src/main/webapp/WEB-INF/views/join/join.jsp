...
<body>
      <form class="container join needs-validation" action="${root}joinAction" method="post" id="joinForm">
         ...
         <div class="row align-items-end justify-content-center needs-validation">
            ...
            <div class="col-md-3 col-lg-2">
               <input name="user_jobgroup" class="form-control" id="excForm" type="text" placeholder="직접 입력" aria-label="Disabled input example" id="validationCustom07"  disabled>   
            </div>
         </div>
...
document.querySelector("#validationCustom06").addEventListener("change", function(){
   if(this.value=="기타") {
      ...
      document.querySelector("#validationCustom07").setAttribute( 'disabled',  false);
   } else {
