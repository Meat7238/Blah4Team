...
- 영화 사운드 오브 뮤직의 ost 인 Do-Re-Mi 中 마리아가 아이들에게 노래에 대해 처음으로 가르쳐주는 대사.

음악 중에서도 어떠한 도구 없이 사람의 목소리만 있으면 할 수 있기 때문에 가장 원초적인 음악 표현의 방법이라고 할 수 있다.

감정을 표현하거나 느끼게 하는 데 매우 효과적이다. 그리고 연애 관계에서 굉장한 효과를 불러일으키기도 한다. 실제로 동물계를 살피면, 노래를 이용해 구애하는 경우가 꽤 많다. 심지어 쥐도 노래한다는 이야기가 있다. 인간의 노래 역시 이런 것의 연장선상으로 이해할 수 있다.
...
아프가니스탄은 성전가를 제외한 모든 노래가 금지되기도 했다.
