		...
		<sec:authentication property="principal" var="user"/>
					...
					<sec:authorize access="isAuthenticated()">
						<form name="form">
							...
							<input type="hidden" id="post_category" name="post_category"
								value="${b.post_category}" />
							<!-- <button type="submit" onclick="reportpop(this.form)">게시글 신고</button> -->	
								 <input type="button" class="button"
								value="게시글 신고" onclick="reportpop(this.form)" />
						</form></sec:authorize></td>
				</tr>
			</table>
			...
			<div>
				...
				<form name="insertReview" action="review" method="post">
					...
					<input type="button" class="button" value="쓰기" onclick="test3()" /> <input
