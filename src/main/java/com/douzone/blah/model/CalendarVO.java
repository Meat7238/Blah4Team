...
public class CalendarVO {
	...
	public Map<String, Integer> today_info(CalendarVO calendarVO) {
		Map<String, Integer> today_Data = new HashMap<String, Integer>();
		Calendar cal = Calendar.getInstance();
		cal.set(Integer.parseInt(calendarVO.getYear()), Integer.parseInt(calendarVO.getMonth()), 1);
		...
		int search_year = Integer.parseInt(calendarVO.getYear());
		int search_month = Integer.parseInt(calendarVO.getMonth()) + 1;
